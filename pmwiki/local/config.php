...
$langshort =   substr( user_language(),0,2);
//include_once($path_to_root.'/modules/wiki/scripts/xlpage-'.$_SESSION['language']->encoding.'.php');

//if ($langshort != 'en')
//	XLPage($langshort, 'PmWiki'.ucfirst($langshort).'.XLPage');
//XLPage('sv', 'PmWiki'.ucfirst('sv').'.XLPage');

XLPage('es', 'PmWikiEs.XLPage');
$PageLogoUrl = $path_to_root . "/themes/default/images/pymenet_small.png";

//$HTTPHeaders[] = 'Content-type: text/html; charset='.
//    $_SESSION['language']->encoding.';';
//$XLLangs=array('pl');
$WhiteUrlPatterns='';
$UserTheme = $path_to_root.'/themes/'.user_theme().'/default.css';
$HTMLHeaderFmt['sitecss'] =
    "<link href='$UserTheme' rel='stylesheet' type='text/css' /> \n";
$FullName = 'stara dupa';
...
$DefaultPasswords['admin'] = '$1$cgTwDJJt$sADW6.7V0j492FedzTi050';
$DefaultPasswords['edit'] = '$1$cgTwDJJt$sADW6.7V0j492FedzTi050';
