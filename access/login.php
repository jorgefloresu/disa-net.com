...
function set_fullmode() {
	...
	if (!$login_timeout) { // FA logo
    	echo "<a target='_blank' href='$power_url'><img src='$path_to_root/themes/$def_theme/images/pymenet_small.png' alt='FrontAccounting' height='50' onload='fixPNG(this)' border='0' /></a>";
	} else { 
