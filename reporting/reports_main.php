...
$reports->addReportClass(_('Nestle'));
$reports->addReport(_('Nestle'),115,_('&Listado de Productos'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM'));
$reports->addReport(_('Nestle'),114,_('&Listado de Tiendas'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM'));
$reports->addReport(_('Nestle'),112,_('&Reporte de Ventas diarias'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM'));
$reports->addReport(_('Nestle'),113,_('&Movimientos de inventario diarios'),
	array(	_('Start Date') => 'DATEBEGINM',
			_('End Date') => 'DATEENDM'));
